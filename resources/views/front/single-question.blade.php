        ...
        <div class="col-md-8">
            ...
            <div class="card bg-dark text-white">
                <div class="card-header">
                    ...
                    <div class="row">
                        ...
                        <div class="ml-3">
                            ...
                            <a href="{{ route('user.public.profile', ['user_id' => $question->user->id, 'user_name' => $question->user->name]) }}" class="text-white">
                                {{ $question->user->name }}
                            </a>
                        </div>
                    </div>
                ...
                <div class="card-body">
                    ...
                    <div class="mr-3" style="display: inline-block">
                        <a class="text-white" href="{{ route('questions.edit', ['id' => $question->id]) }}"><i class="fas fa-edit"></i></a>
                    </div>
                    @endcan

                    {{-- Report Question --}}
                    @auth
                    <form method="POST" action="{{ route('questions.report', ['id' => $question->id]) }}" style="display: inline-block">
                        @csrf
                ...
                <div>
                    ...
                    <a href="{{ route('questions.with.tag', $tag->title) }}" style="font-size: 1.1rem" class="badge badge-secondary ml-2 mb-2">{{ $tag->title }}</a>
                    @endforeach
                </div>
                @endif
            </div>
            ...
            <div class="card bg-dark text-white mb-2">
                <div class="card-header">
                    <div class="row">
                        ...
                        <div class="ml-3">
                            ...
                            <a href="{{ route('user.public.profile', ['user_id' => $answer->user->id, 'user_name' => $answer->user->name]) }}" class="text-white">
                                {{ $answer->user->name }}
                            </a>
                        </div>
                ...
                <div class="card-body">
                    ...
                    @can('edit', $answer)
                    <div class="mr-3" style="display: inline-block">
                        <a class="text-white" href="{{ route('answers.edit', ['id' => $answer->id]) }}"><i class="fas fa-edit"></i></a>
                    </div>
                    @endcan
            ...
            <form action="{{ route('answers.store', ['question_id' => $question->id]) }}" method="POST">
                ...
                <div class="form-group">
                    ...
                    <textarea class="form-control bg-dark text-white @error('body') is-invalid @enderror" name="body" cols="30" rows="10"></textarea>
                    @error('body')
                    <div>
