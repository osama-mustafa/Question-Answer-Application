                    ...
                    <div class="card-body">
                        <form method="POST" action="{{ route('questions.update', ['id' => $question->id]) }}">
                            ...
                            <div class="form-group pb-2">
                                ...
                                <input type="text" name="title" class="bg-dark text-white form-control @error('title') is-invalid @enderror"
                            ...
                            <div class="form-group">
                                ...
                                <textarea class="bg-dark text-white form-control @error('body') is-invalid @enderror" id="body" name="body"
                                    rows="3">{{ $question->body }}</textarea>
                                @error('body')
                                    <small class="text-danger">
                                        {{ $message }}
                                    </small>
