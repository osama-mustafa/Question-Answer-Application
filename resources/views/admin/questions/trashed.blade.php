    ...
    <table class="table table-dark">
        ...
        <tbody>
            ...
            <tr>
                ...
                <td>
                    <a class="btn btn-primary btn-sm" href="{{ route('admin.questions.restore', ['id' => $question->id]) }}">Restore
                ...
                <td>
                    <form action="{{ route('admin.questions.force.delete', ['id' => $question->id]) }}" method="POST">
                        @csrf
                        @method('DELETE')
                        <button class="btn btn-danger btn-sm" type="submit">Delete <i class="fas fa-trash"></i>
                        </button>
                    </form>
                </td>
            </tr>
