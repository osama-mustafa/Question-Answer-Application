            ...
            <div class="container">
                ...
                <div class="collapse navbar-collapse" id="navbarSupportedContent">
                    ...
                    <ul class="navbar-nav ml-auto navbar-dark">
                        ...
                        <li class="nav-item dropdown bg-dark">
                            ...
                            <div class="dropdown-menu dropdown-menu-right bg-dark" aria-labelledby="navbarDropdown">
                                ...
                                <a class="dropdown-item text-white" href="{{ route('password.edit') }}">Change
                                    Password</a>
                                <a class="dropdown-item text-white" href="{{ route('user.public.profile',
                        ...
                        @if (Auth::user()->image)
                        <li class="nav-item">
                            <img class="rounded-circle" width="40" height="40" src="{{ asset('storage/images/'. Auth::user()->image) }}" alt="">
                        </li>
                        @else
                        <li class="nav-item">
                            <img class="rounded-circle" width="40" height="40" src="{{ asset('storage/images/profile.png') }}" alt="">
                        </li>
                        @endif
